...
class Prepare:
    ...
    def _unzip(self):
        ...
        child = subprocess32.Popen(['unzip', self.ai['absPath'], '-d', self.tmpdir], stdout=subprocess32.PIPE, stderr=subprocess32.PIPE)
    ...
    def _compile(self):
        ...
        child = subprocess32.Popen(cflags + cpps, stdout=subprocess32.PIPE, stderr=subprocess32.PIPE)
